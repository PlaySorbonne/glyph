...
export default function GoogleBtn({ allowLogin }: { allowLogin?: boolean }) {
  return (
    <Link
      href={`https://accounts.google.com/o/oauth2/v2/auth?client_id=${process.env.AUTH_GOOGLE_ID}&redirect_uri=${process.env.NEXT_PUBLIC_MAIN_URL}${googleCallback}&response_type=code&scope=email+profile`}
