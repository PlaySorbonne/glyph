  ...
  return (
    <>
      ...
      <div>
        ...
        vous et notre site Web. Nous utilisons également, comme indiqué dans la
      ...
      <div>
        Le droit d&apos;opposition s&apos;entend comme étant la possiblité
      ...
      <div>Courriel :&nbsp; dev@playsorbonne.fr</div>
      <h2>Droit d&apos;accès</h2>
      <div>
      ...
      <div>
        <ul>
          ...
          <li>Hashage des informations sensibles</li>
        </ul>
      </div>
      <div>
